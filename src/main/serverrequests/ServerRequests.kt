...
object ServerRequests {
    ...
    @JvmStatic fun main(args: Array<String>) {
        ...
        //        paths.put("germany/steel-2015-12-09", "http://www.handelsvertreterangebote.com/Handelsvertreter_Automotive-Beleuchtung-M%C3%B6bel-und-Maschinen-Ausr%C3%BCstungen_2208700003-51.html");
        //        paths.put("germany/home", "http://www.handelsvertreterangebote.com");
        //        paths.put("germany/wine-2015-12-09", "http://www.handelsvertreterangebote.com/Handelsvertreter_Bars-Restaurant-Hotel-Weine-und-Getr%C3%A4nke_2287600001-18.html");
        //        paths.put("germany/contacts", "http://www.handelsvertreterangebote.com/");
        //        paths.put("venditori/auguri-natale-2015", "http://www.venditori.it/");
        //
        //        paths.put("consigli/donne-di-denari-ebook", "http://www.amazon.it/Donne-denari-strategie-vincenti-gestire-ebook/dp/B014DS365U");
        //        paths.put("consigli/donne-di-denari-libro", "http://www.deagostinilibri.it/dl_it/donne-di-denari.html");
        //        paths.put("consigli/donne-di-denari-sito", "http://www.deagostini.it/prodotti/donne-di-denari");
